...
internal sealed class TextEditor
{
    ...
    /// Call editor.Mainloop() to activate the editor
    /// </summary>
    /// <param name="text">The text to open the Editor to</param>
    /// <param name="isJson">Does the note contain only JSON text?</param>
    public Editor(string text, bool isJson)
    {
        ...
        // Display the note in the editor
        Console.Write(existing_note);
    }
